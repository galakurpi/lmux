...
export const KEYBINDING_DEFINITIONS: KeybindingDefinition[] = [
  ...
  { action: "workspace.close", title: "Close workspace", category: "Workspace", defaultShortcut: "ctrl+shift+q" },
  ...
  { action: "pane.focus.left", title: "Focus pane left", category: "Pane", defaultShortcut: "ctrl+shift+arrowleft" },
  { action: "pane.focus.right", title: "Focus pane right", category: "Pane", defaultShortcut: "ctrl+shift+arrowright" },
  { action: "pane.focus.up", title: "Focus pane up", category: "Pane", defaultShortcut: "ctrl+shift+arrowup" },
  { action: "pane.focus.down", title: "Focus pane down", category: "Pane", defaultShortcut: "ctrl+shift+arrowdown" },
  { action: "pane.split.right", title: "Split pane right", category: "Pane", defaultShortcut: "ctrl+shift+d" },
  { action: "pane.split.down", title: "Split pane down", category: "Pane", defaultShortcut: "ctrl+shift+x" },
  { action: "pane.close", title: "Close active pane", category: "Pane", defaultShortcut: "ctrl+shift+w" },
  { action: "pane.newBrowserTab", title: "Open browser tab in pane", category: "Pane", defaultShortcut: "ctrl+shift+l" },
  { action: "pane.focus.latestUnread", title: "Focus latest unread pane", category: "Pane", defaultShortcut: "ctrl+shift+u" },
